...
\title{Hydrogen Atom\\Radial Functions}
...
This report presents computational analysis of hydrogen atom.
...
plt.tight_layout()
plt.savefig('hydrogen_atom_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hydrogen_atom_plot1.pdf}
...
plt.tight_layout()
plt.savefig('hydrogen_atom_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hydrogen_atom_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('hydrogen_atom_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hydrogen_atom_plot3.pdf}
...
plt.tight_layout()
plt.savefig('hydrogen_atom_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hydrogen_atom_plot4.pdf}
...
plt.tight_layout()
plt.savefig('hydrogen_atom_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hydrogen_atom_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('hydrogen_atom_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hydrogen_atom_plot6.pdf}
...
This analysis demonstrates the computational approach to hydrogen atom.
