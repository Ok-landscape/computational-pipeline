...
\title{Big Bang Cosmology\\Nucleosynthesis and CMB}
...
This report presents computational analysis of big bang.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{big_bang_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{big_bang_plot2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{big_bang_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{big_bang_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{big_bang_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('big_bang_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{big_bang_plot6.pdf}
...
This analysis demonstrates the computational approach to big bang.
