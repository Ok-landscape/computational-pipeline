...
\begin{abstract}
Detection theory in psychology.
\end{abstract}

\section{Introduction}

This report presents computational analysis of signal detection.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{signal_detection_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{signal_detection_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{signal_detection_plot6.pdf}
...
This analysis demonstrates the computational approach to signal detection.
