...
\begin{abstract}
Models of human color vision.
\end{abstract}

\section{Introduction}

This report presents computational analysis of color perception.
...
This analysis demonstrates the computational approach to color perception.
