...
\title{Photonic Crystals\\Band Structure}
...
This report presents computational analysis of photonic crystals.
...
plt.tight_layout()
plt.savefig('photonic_crystals_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{photonic_crystals_plot1.pdf}
...
plt.tight_layout()
plt.savefig('photonic_crystals_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{photonic_crystals_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('photonic_crystals_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{photonic_crystals_plot3.pdf}
...
plt.tight_layout()
plt.savefig('photonic_crystals_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{photonic_crystals_plot4.pdf}
...
plt.tight_layout()
plt.savefig('photonic_crystals_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{photonic_crystals_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('photonic_crystals_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{photonic_crystals_plot6.pdf}
...
This analysis demonstrates the computational approach to photonic crystals.
