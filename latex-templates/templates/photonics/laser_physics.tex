...
\title{Laser Physics\\Rate Equations}
...
\begin{abstract}
Laser operation and gain dynamics.
\end{abstract}

\section{Introduction}

This report presents computational analysis of laser physics.
...
plt.tight_layout()
plt.savefig('laser_physics_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{laser_physics_plot1.pdf}
...
plt.tight_layout()
plt.savefig('laser_physics_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{laser_physics_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('laser_physics_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{laser_physics_plot3.pdf}
...
plt.tight_layout()
plt.savefig('laser_physics_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{laser_physics_plot4.pdf}
...
plt.tight_layout()
plt.savefig('laser_physics_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{laser_physics_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('laser_physics_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{laser_physics_plot6.pdf}
...
This analysis demonstrates the computational approach to laser physics.
