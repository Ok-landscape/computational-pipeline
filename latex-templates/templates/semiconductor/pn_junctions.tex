...
\title{PN Junctions\\Diode Characteristics}
\author{Semiconductor Research Group}
\date{\today}
...
This report presents computational analysis of pn junctions.
...
plt.tight_layout()
plt.savefig('pn_junctions_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pn_junctions_plot1.pdf}
...
plt.tight_layout()
plt.savefig('pn_junctions_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pn_junctions_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('pn_junctions_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pn_junctions_plot3.pdf}
...
plt.tight_layout()
plt.savefig('pn_junctions_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{pn_junctions_plot4.pdf}
...
plt.tight_layout()
plt.savefig('pn_junctions_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pn_junctions_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('pn_junctions_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pn_junctions_plot6.pdf}
...
This analysis demonstrates the computational approach to pn junctions.
