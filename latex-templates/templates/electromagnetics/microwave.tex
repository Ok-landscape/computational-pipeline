...
\title{Microwave Engineering\\S-Parameters}
...
\begin{abstract}
Microwave network analysis and impedance matching.
\end{abstract}

\section{Introduction}

This report presents computational analysis of microwave.
...
plt.tight_layout()
plt.savefig('microwave_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{microwave_plot1.pdf}
...
plt.tight_layout()
plt.savefig('microwave_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{microwave_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('microwave_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{microwave_plot3.pdf}
...
plt.tight_layout()
plt.savefig('microwave_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{microwave_plot4.pdf}
...
plt.tight_layout()
plt.savefig('microwave_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{microwave_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('microwave_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{microwave_plot6.pdf}
...
This analysis demonstrates the computational approach to microwave.
