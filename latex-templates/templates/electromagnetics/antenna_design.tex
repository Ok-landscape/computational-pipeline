...
\title{Antenna Design\\Radiation Patterns}
...
\begin{abstract}
Antenna radiation characteristics and gain.
\end{abstract}

\section{Introduction}

This report presents computational analysis of antenna design.
...
plt.tight_layout()
plt.savefig('antenna_design_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{antenna_design_plot1.pdf}
...
plt.tight_layout()
plt.savefig('antenna_design_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{antenna_design_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('antenna_design_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{antenna_design_plot3.pdf}
...
plt.tight_layout()
plt.savefig('antenna_design_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{antenna_design_plot4.pdf}
...
plt.tight_layout()
plt.savefig('antenna_design_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{antenna_design_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('antenna_design_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{antenna_design_plot6.pdf}
...
This analysis demonstrates the computational approach to antenna design.
