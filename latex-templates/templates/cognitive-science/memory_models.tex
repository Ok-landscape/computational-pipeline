...
\begin{abstract}
Mathematical models of human memory including retention and recall.
\end{abstract}

\section{Introduction}

This report presents computational analysis of memory models.
...
This analysis demonstrates the computational approach to memory models.
