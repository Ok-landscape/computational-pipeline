...
\title{Attention\\Signal Detection Theory}
...
\begin{abstract}
Models of visual attention and signal detection in cognitive tasks.
\end{abstract}

\section{Introduction}

This report presents computational analysis of attention.
...
plt.tight_layout()
plt.savefig('attention_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{attention_plot1.pdf}
...
plt.tight_layout()
plt.savefig('attention_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{attention_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('attention_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{attention_plot3.pdf}
...
plt.tight_layout()
plt.savefig('attention_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{attention_plot4.pdf}
...
plt.tight_layout()
plt.savefig('attention_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{attention_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('attention_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{attention_plot6.pdf}
...
This analysis demonstrates the computational approach to attention.
