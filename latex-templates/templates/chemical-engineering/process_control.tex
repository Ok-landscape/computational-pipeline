...
\begin{abstract}
Control system design for chemical processes including PID tuning.
\end{abstract}

\section{Introduction}

This report presents computational analysis of process control.
...
This analysis demonstrates the computational approach to process control.
