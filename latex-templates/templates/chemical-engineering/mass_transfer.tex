...
\title{Mass Transfer\\Diffusion and Convection}
...
\begin{abstract}
Mass transfer operations including diffusion, convection, and film theory.
\end{abstract}

\section{Introduction}

This report presents computational analysis of mass transfer.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{mass_transfer_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{mass_transfer_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{mass_transfer_plot4.pdf}
...
This analysis demonstrates the computational approach to mass transfer.
