...
\begin{abstract}
Design and analysis of chemical reactors including continuous stirred tanks and plug flow reactors.
\end{abstract}

\section{Introduction}

This report presents computational analysis of reaction engineering.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{reaction_engineering_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{reaction_engineering_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{reaction_engineering_plot4.pdf}
...
This analysis demonstrates the computational approach to reaction engineering.
