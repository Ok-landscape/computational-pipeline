...
\begin{abstract}
Design of separation operations including McCabe-Thiele distillation.
\end{abstract}

\section{Introduction}

This report presents computational analysis of separation processes.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{separation_processes_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{separation_processes_plot2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{separation_processes_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{separation_processes_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{separation_processes_plot5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{separation_processes_plot6.pdf}
...
This analysis demonstrates the computational approach to separation processes.
