...
\title{Ocean Productivity\\NPP and Chlorophyll}
...
This report presents computational analysis of ocean productivity.
...
plt.tight_layout()
plt.savefig('ocean_productivity_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{ocean_productivity_plot1.pdf}
...
plt.tight_layout()
plt.savefig('ocean_productivity_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{ocean_productivity_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('ocean_productivity_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{ocean_productivity_plot3.pdf}
...
plt.tight_layout()
plt.savefig('ocean_productivity_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{ocean_productivity_plot4.pdf}
...
plt.tight_layout()
plt.savefig('ocean_productivity_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{ocean_productivity_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('ocean_productivity_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{ocean_productivity_plot6.pdf}
...
This analysis demonstrates the computational approach to ocean productivity.
