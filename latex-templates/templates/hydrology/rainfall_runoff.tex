...
\title{Rainfall-Runoff\\Unit Hydrograph}
...
This report presents computational analysis of rainfall runoff.
...
plt.tight_layout()
plt.savefig('rainfall_runoff_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{rainfall_runoff_plot1.pdf}
...
plt.tight_layout()
plt.savefig('rainfall_runoff_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{rainfall_runoff_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('rainfall_runoff_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{rainfall_runoff_plot3.pdf}
...
plt.tight_layout()
plt.savefig('rainfall_runoff_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{rainfall_runoff_plot4.pdf}
...
plt.tight_layout()
plt.savefig('rainfall_runoff_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{rainfall_runoff_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('rainfall_runoff_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{rainfall_runoff_plot6.pdf}
...
This analysis demonstrates the computational approach to rainfall runoff.
