...
\title{Flood Frequency\\Return Periods}
...
\begin{abstract}
Statistical analysis of extreme flows.
\end{abstract}

\section{Introduction}

This report presents computational analysis of flood frequency.
...
plt.tight_layout()
plt.savefig('flood_frequency_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{flood_frequency_plot1.pdf}
...
plt.tight_layout()
plt.savefig('flood_frequency_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{flood_frequency_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('flood_frequency_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{flood_frequency_plot3.pdf}
...
plt.tight_layout()
plt.savefig('flood_frequency_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{flood_frequency_plot4.pdf}
...
plt.tight_layout()
plt.savefig('flood_frequency_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{flood_frequency_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('flood_frequency_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{flood_frequency_plot6.pdf}
...
This analysis demonstrates the computational approach to flood frequency.
