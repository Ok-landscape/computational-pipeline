...
\title{Hash Functions\\Collision Resistance}
...
\begin{abstract}
Cryptographic hash function properties and applications.
\end{abstract}

\section{Introduction}

This report presents computational analysis of hash functions.
...
plt.tight_layout()
plt.savefig('hash_functions_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hash_functions_plot1.pdf}
...
plt.tight_layout()
plt.savefig('hash_functions_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hash_functions_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('hash_functions_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hash_functions_plot3.pdf}
...
plt.tight_layout()
plt.savefig('hash_functions_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{hash_functions_plot4.pdf}
...
plt.tight_layout()
plt.savefig('hash_functions_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hash_functions_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('hash_functions_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{hash_functions_plot6.pdf}
...
This analysis demonstrates the computational approach to hash functions.
