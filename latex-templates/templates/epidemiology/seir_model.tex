...
\title{SEIR Model\\Exposed Compartment}
...
\begin{abstract}
Epidemic modeling with latent period.
\end{abstract}

\section{Introduction}

This report presents computational analysis of seir model.
...
plt.tight_layout()
plt.savefig('seir_model_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{seir_model_plot1.pdf}
...
plt.tight_layout()
plt.savefig('seir_model_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{seir_model_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('seir_model_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{seir_model_plot3.pdf}
...
plt.tight_layout()
plt.savefig('seir_model_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{seir_model_plot4.pdf}
...
plt.tight_layout()
plt.savefig('seir_model_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{seir_model_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('seir_model_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{seir_model_plot6.pdf}
...
This analysis demonstrates the computational approach to seir model.
