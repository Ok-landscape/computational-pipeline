...
\title{Network Epidemiology\\Contact Networks}
...
This report presents computational analysis of network epidemics.
...
plt.tight_layout()
plt.savefig('network_epidemics_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{network_epidemics_plot1.pdf}
...
plt.tight_layout()
plt.savefig('network_epidemics_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{network_epidemics_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('network_epidemics_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{network_epidemics_plot3.pdf}
...
plt.tight_layout()
plt.savefig('network_epidemics_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{network_epidemics_plot4.pdf}
...
plt.tight_layout()
plt.savefig('network_epidemics_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{network_epidemics_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('network_epidemics_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{network_epidemics_plot6.pdf}
...
This analysis demonstrates the computational approach to network epidemics.
