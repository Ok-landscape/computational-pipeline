...
\title{Spatial Epidemiology\\Diffusion Models}
...
This report presents computational analysis of spatial epidemiology.
...
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{spatial_epidemiology_plot1.pdf}
...
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{spatial_epidemiology_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{spatial_epidemiology_plot3.pdf}
...
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{spatial_epidemiology_plot4.pdf}
...
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{spatial_epidemiology_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('spatial_epidemiology_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{spatial_epidemiology_plot6.pdf}
...
This analysis demonstrates the computational approach to spatial epidemiology.
