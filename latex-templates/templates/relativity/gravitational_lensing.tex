...
\title{Gravitational Lensing\\Einstein Rings}
...
This report presents computational analysis of gravitational lensing.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gravitational_lensing_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gravitational_lensing_plot2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gravitational_lensing_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gravitational_lensing_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gravitational_lensing_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('gravitational_lensing_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gravitational_lensing_plot6.pdf}
...
This analysis demonstrates the computational approach to gravitational lensing.
