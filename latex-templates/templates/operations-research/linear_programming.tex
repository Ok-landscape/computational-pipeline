...
\title{Linear Programming\\Simplex Method}
...
This report presents computational analysis of linear programming.
...
plt.tight_layout()
plt.savefig('linear_programming_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{linear_programming_plot1.pdf}
...
plt.tight_layout()
plt.savefig('linear_programming_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{linear_programming_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('linear_programming_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{linear_programming_plot3.pdf}
...
plt.tight_layout()
plt.savefig('linear_programming_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{linear_programming_plot4.pdf}
...
plt.tight_layout()
plt.savefig('linear_programming_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{linear_programming_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('linear_programming_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{linear_programming_plot6.pdf}
...
This analysis demonstrates the computational approach to linear programming.
