...
\title{Scheduling\\Job Shop Problems}
...
\begin{abstract}
Sequencing and scheduling optimization.
\end{abstract}

\section{Introduction}

This report presents computational analysis of scheduling.
...
plt.tight_layout()
plt.savefig('scheduling_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{scheduling_plot1.pdf}
...
plt.tight_layout()
plt.savefig('scheduling_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{scheduling_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('scheduling_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{scheduling_plot3.pdf}
...
plt.tight_layout()
plt.savefig('scheduling_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{scheduling_plot4.pdf}
...
plt.tight_layout()
plt.savefig('scheduling_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{scheduling_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('scheduling_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{scheduling_plot6.pdf}
...
This analysis demonstrates the computational approach to scheduling.
