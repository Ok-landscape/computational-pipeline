...
\title{Food Web Dynamics\\Trophic Levels}
...
\begin{abstract}
Energy flow and stability in ecological networks.
\end{abstract}

\section{Introduction}

This report presents computational analysis of food webs.
...
plt.tight_layout()
plt.savefig('food_webs_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{food_webs_plot1.pdf}
...
plt.tight_layout()
plt.savefig('food_webs_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{food_webs_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('food_webs_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{food_webs_plot3.pdf}
...
plt.tight_layout()
plt.savefig('food_webs_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{food_webs_plot4.pdf}
...
plt.tight_layout()
plt.savefig('food_webs_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{food_webs_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('food_webs_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{food_webs_plot6.pdf}
...
This analysis demonstrates the computational approach to food webs.
