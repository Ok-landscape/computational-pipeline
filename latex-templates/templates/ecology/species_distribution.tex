...
\title{Species Distribution\\Niche Modeling}
...
\begin{abstract}
Habitat suitability and species range prediction.
\end{abstract}

\section{Introduction}

This report presents computational analysis of species distribution.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{species_distribution_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{species_distribution_plot2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{species_distribution_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{species_distribution_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{species_distribution_plot5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{species_distribution_plot6.pdf}
...
This analysis demonstrates the computational approach to species distribution.
