...
\title{Metapopulation Dynamics\\Patch Models}
...
\begin{abstract}
Spatial population dynamics and connectivity.
\end{abstract}

\section{Introduction}

This report presents computational analysis of metapopulation.
...
plt.tight_layout()
plt.savefig('metapopulation_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{metapopulation_plot1.pdf}
...
plt.tight_layout()
plt.savefig('metapopulation_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{metapopulation_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('metapopulation_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{metapopulation_plot3.pdf}
...
plt.tight_layout()
plt.savefig('metapopulation_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{metapopulation_plot4.pdf}
...
plt.tight_layout()
plt.savefig('metapopulation_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{metapopulation_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('metapopulation_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{metapopulation_plot6.pdf}
...
This analysis demonstrates the computational approach to metapopulation.
