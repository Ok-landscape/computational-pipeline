...
\begin{abstract}
Traffic flow modeling using fundamental diagrams and wave propagation.
\end{abstract}

\section{Introduction}

This report presents computational analysis of traffic flow.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{traffic_flow_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{traffic_flow_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{traffic_flow_plot4.pdf}
...
This analysis demonstrates the computational approach to traffic flow.
