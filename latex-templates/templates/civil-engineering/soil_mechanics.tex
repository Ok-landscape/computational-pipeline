...
\title{Soil Mechanics\\Consolidation and Bearing Capacity}
...
\begin{abstract}
Geotechnical analysis including settlement and foundation design.
\end{abstract}

\section{Introduction}

This report presents computational analysis of soil mechanics.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{soil_mechanics_plot1.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{soil_mechanics_plot2.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{soil_mechanics_plot3.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{soil_mechanics_plot4.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{soil_mechanics_plot5.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{soil_mechanics_plot6.pdf}
...
This analysis demonstrates the computational approach to soil mechanics.
