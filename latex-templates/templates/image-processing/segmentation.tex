...
\title{Image Segmentation\\Thresholding}
...
This report presents computational analysis of segmentation.
...
plt.tight_layout()
plt.savefig('segmentation_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{segmentation_plot1.pdf}
...
plt.tight_layout()
plt.savefig('segmentation_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{segmentation_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('segmentation_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{segmentation_plot3.pdf}
...
plt.tight_layout()
plt.savefig('segmentation_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{segmentation_plot4.pdf}
...
plt.tight_layout()
plt.savefig('segmentation_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{segmentation_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('segmentation_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{segmentation_plot6.pdf}
...
This analysis demonstrates the computational approach to segmentation.
