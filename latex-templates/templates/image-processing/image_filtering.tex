...
\title{Image Filtering\\Convolution}
\author{Image Processing Research Group}
\date{\today}
...
This report presents computational analysis of image filtering.
...
plt.tight_layout()
plt.savefig('image_filtering_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{image_filtering_plot1.pdf}
...
plt.tight_layout()
plt.savefig('image_filtering_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{image_filtering_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('image_filtering_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{image_filtering_plot3.pdf}
...
plt.tight_layout()
plt.savefig('image_filtering_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{image_filtering_plot4.pdf}
...
plt.tight_layout()
plt.savefig('image_filtering_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{image_filtering_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('image_filtering_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{image_filtering_plot6.pdf}
...
This analysis demonstrates the computational approach to image filtering.
