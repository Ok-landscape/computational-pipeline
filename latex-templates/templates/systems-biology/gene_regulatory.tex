...
\title{Gene Regulatory Networks\\Boolean Models}
...
This report presents computational analysis of gene regulatory.
...
plt.tight_layout()
plt.savefig('gene_regulatory_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gene_regulatory_plot1.pdf}
...
plt.tight_layout()
plt.savefig('gene_regulatory_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gene_regulatory_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('gene_regulatory_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gene_regulatory_plot3.pdf}
...
plt.tight_layout()
plt.savefig('gene_regulatory_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{gene_regulatory_plot4.pdf}
...
plt.tight_layout()
plt.savefig('gene_regulatory_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gene_regulatory_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('gene_regulatory_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{gene_regulatory_plot6.pdf}
...
This analysis demonstrates the computational approach to gene regulatory.
