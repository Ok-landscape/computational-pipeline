...
\title{Extreme Value Theory\\GEV Distribution}
...
This report presents computational analysis of extreme value.
...
plt.tight_layout()
plt.savefig('extreme_value_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{extreme_value_plot1.pdf}
...
plt.tight_layout()
plt.savefig('extreme_value_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{extreme_value_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('extreme_value_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{extreme_value_plot3.pdf}
...
plt.tight_layout()
plt.savefig('extreme_value_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{extreme_value_plot4.pdf}
...
plt.tight_layout()
plt.savefig('extreme_value_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{extreme_value_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('extreme_value_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{extreme_value_plot6.pdf}
...
This analysis demonstrates the computational approach to extreme value.
