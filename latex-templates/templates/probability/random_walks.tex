...
\title{Random Walks\\First Passage}
...
\begin{abstract}
Stochastic walks and diffusion.
\end{abstract}

\section{Introduction}

This report presents computational analysis of random walks.
...
plt.tight_layout()
plt.savefig('random_walks_plot1.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{random_walks_plot1.pdf}
...
plt.tight_layout()
plt.savefig('random_walks_plot2.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{random_walks_plot2.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('random_walks_plot3.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{random_walks_plot3.pdf}
...
plt.tight_layout()
plt.savefig('random_walks_plot4.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{random_walks_plot4.pdf}
...
plt.tight_layout()
plt.savefig('random_walks_plot5.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{random_walks_plot5.pdf}
...
ax.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig('random_walks_plot6.pdf', dpi=150, bbox_inches='tight')
plt.close()
\end{pycode}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{random_walks_plot6.pdf}
...
This analysis demonstrates the computational approach to random walks.
